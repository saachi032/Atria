...
const weeklyChartData = [
  ...
  { day: "Tue", donations: 18, requests: 20 },
  { day: "Wed", donations: 25, requests: 15 },
  { day: "Thu", donations: 22, requests: 24 },
  { day: "Fri", donations: 30, requests: 18 },
  { day: "Sat", donations: 12, requests: 10 },
  ...
  return (
    <div className="flex h-screen bg-gray-50 font-sans">
      ...
      <main className="flex-1 p-8 overflow-y-auto animate-fade-in">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 space-y-6">
            ...
            <div className="pt-4 border-t">
              ...
              <div className="space-y-3">
                ...
                <button
                  onClick={() => setShowDonorAlert(true)}
        ...
        <CreateRequestModal isOpen={showCreateRequest} onClose={() => setShowCreateRequest(false)} />
        <RecordDonationModal isOpen={showRecordDonation} onClose={() => setShowRecordDonation(false)} />
        <SendDonorAlertModal isOpen={showDonorAlert} onClose={() => setShowDonorAlert(false)} />
      </main>
    </div>
  )
}
