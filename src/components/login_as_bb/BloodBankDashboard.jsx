...
// --- SVG Icons ---
const DropletsIcon = (props) => (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M7 16.3c.5.5 1.2 1 2.2 1.7.9.7 1.8 1 2.8 1 .9 0 1.8-.3 2.8-1 .9-.7 1.7-1.2 2.2-1.7M12 22v-2.2M18.3 5.4A6.4 6.4 0 0 0 12 2a6.4 6.4 0 0 0-6.3 3.4"/><path d="M12 2v7.3"/><path d="m 5.7,14 a 6.4,6.4 0 0 0 12.6,0"/></svg>);
const BellIcon = (props) => (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/></svg>);
const CalendarIcon = (props) => (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>);
const AlertTriangleIcon = (props) => (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m21.73 18-8-14a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><line x1="12" x2="12" y1="9" y2="13"/><line x1="12" x2="12.01" y1="17" y2="17"/></svg>);
const PlusCircleIcon = (props) => (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circleircle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="16"/><line x1="8" x2="16" y1="12" y2="12"/></svg>);
const ClipboardIcon = (props) => (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/></svg>);
const SendIcon = (props) => (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>);

// --- Mock Data ---
const inventoryData = [
  { type: 'A+', units: 85 }, { type: 'A-', units: 12 },
  { type: 'B+', units: 40 }, { type: 'B-', units: 10 },
  { type: 'O+', units: 140 }, { type: 'O-', units: 30 },
  { type: 'AB+', units: 27 }, { type: 'AB-', units: 7 },
];
const pendingRequests = [
  { id: "BB-1240", hospital: "Metro Hospital", type: "A+", units: 1, date: "2024-10-28" },
  { id: "BB-1239", hospital: "HealthPlus Clinic", type: "O-", units: 2, date: "2024-10-27" },
];
const weeklyChartData = [
  { day: 'Mon', donations: 12, requests: 10 }, { day: 'Tue', donations: 15, requests: 14 },
  { day: 'Wed', donations: 16, requests: 18 }, { day: 'Thu', donations: 14, requests: 17 },
  { day: 'Fri', donations: 20, requests: 15 }, { day: 'Sat', donations: 9, requests: 8 },
...
export default function BloodBankDashboard() {
  ...
  const totalScheduledDonations = 28;
  ...
  const statsCards = [
    ...
    { title: "Pending Requests", value: animatedPendingRequests, icon: <BellIcon className="w-8 h-8"/>, color: "yellow", tooltip: "Requests from hospitals awaiting fulfillment." },
    { title: "Scheduled Donations", value: animatedScheduledDonations, icon: <CalendarIcon className="w-8 h-8"/>, color: "green", tooltip: "Upcoming donation appointments." },
    { title: "Urgent Needs", value: animatedAlerts, icon: <AlertTriangleIcon className="w-8 h-8"/>, color: "red", tooltip: `Blood types below ${LOW_STOCK_THRESHOLD} units.` },
  ];
                ...
                <div className="py-2 max-h-96 overflow-y-auto">
                  {pendingRequests.map(req => (
                    <div key={req.id} className="px-4 py-2 hover:bg-gray-100">
                      ...
                      <p className="text-xs text-gray-500">From {req.hospital}</p>
                    </div>
                  ))}
